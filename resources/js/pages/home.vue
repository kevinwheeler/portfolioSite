    ...
    <main ref="main">
        ...
        <section aria-label="Portfolio projects" class="mb-20">
          ...
          <div class="flex flex-col md:flex-row gap-6 mb-24 duration-1000 transition md:motion-reduce:from-cancel data-inviewport md:from-left">
              <NothingButHeadlinesCard additionalClasses="from-right md:from-cancel motion-reduce:from-cancel" alt="Screenshot of Nothing But Headlines app" />
              <TranslateSearchCard     additionalClasses="from-left md:from-cancel motion-reduce:from-cancel" alt="Screenshot of Translate Search app"/>
          ...
          <div class="flex flex-col md:flex-row gap-6 mb-12 duration-1000 transition data-inviewport md:from-right md:motion-reduce:from-cancel">
              <RandomVideoCard   additionalClasses="from-left md:from-cancel motion-reduce:from-cancel" alt="Screenshot of Random Video app" />
              <GeomesaGuiCard    additionalClasses="from-right md:from-cancel motion-reduce:from-cancel" alt="GeoMesa logo"/>
              <PortfolioSiteCard additionalClasses="from-left md:from-cancel motion-reduce:from-cancel" alt="Screenshot of portfolio website"/>
          </div>
          <div class="flex flex-col md:flex-row gap-6 mb-12 duration-1000 transition data-inviewport md:from-left md:motion-reduce:from-cancel">
              ...
              <KeyboardSmashCard additionalClasses="from-right md:translate-x-1/2+12px md:from-cancel motion-reduce:from-cancel" alt="Screnshot of Baby Keyboard Smash game"/>
              <UbuntuVpsCard     additionalClasses="from-left  md:translate-x-1/2+12px md:from-cancel motion-reduce:from-cancel" alt="Ubuntu logo"/>

<template>
    <main>
        <div class="flex flex-col gap-6">
            ...
            <div class="text-2xl">
                <p class="mb-8">
                    Open source contribution taking GeoMesa's shell/stub of a GUI and adding a map to it after also adding OpenLayers to the project.
                    Then finished functionaliy to show data points on a map and to display their info when clicked. Data points were 
                    retrieved from a GeoMesa database using Open Geospatial Consortium standard WMS interface calls.
                </p>
            </div>
            ...
            <ul class="mb-48">
                <li class="text-2xl mb-4 list-style-blue-bullet"><router-link class="underline" to="/projects/density-iterator">GeoMesa Temporal Density Iterator</router-link></li>
            </ul>
        </div>
    </main> 
</template>
